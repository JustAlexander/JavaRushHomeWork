...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            Human ivanov = new Human("Ivanov", new Asset("home"), new Asset("car"), new Asset("dog"));
            ivanov.save(outputStream);
            ivanov.assets.get(1).save(outputStream);
            outputStream.flush();
    ...
    public static class Human {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            for (int i = 0; i < size; i++) {
                String[] line = reader.readLine().split("<separ>");
                if (line.length != 0) {
                    assets.add(new Asset(line[0]));
                    //assets.get(i).setPrice(Double.parseDouble(line[1]));
                }
            }
        }
    }
